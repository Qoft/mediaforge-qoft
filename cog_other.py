...
from mainutils import improcess, imagesearch, saveurls
...
class Other(commands.Cog, name="Other"):
    ...
    async def about(self, ctx):
        ...
        :param ctx: discord context
        """
        embed = discord.Embed(color=discord.Color(0xD262BA), title="MediaForge (qoft edit)")
        embed.add_field(name="Official MediaForge Discord Server", value=f"[Join here!](https://discord.gg/xwWjgyVqBz)")
        embed.add_field(name="Add MediaForge (qoft edit) to your server",
                        value=f"[Add me here!](https://discord.com/api/oauth2/authorize?client_id=962135197653037132&permissions=8&scope=bot%20applications.commands)")
        embed.add_field(name="MediaForge (qoft edit) GitHub", value=f"https://github.com/qoft/mediaforge-qoft")
        embed.add_field(name="Official MediaForge GitHub", value=f"https://github.com/HexCodeFFF/mediaforge")
        await ctx.reply(embed=embed)
    ...
    async def privacy(self, ctx):
        ...
        embed.add_field(name="Contact about data", value=f"There really isn't anything to contact me about since "
                                                         ...
                                                         f"https://github.com/qoft/mediaforge-qoft).")
        await ctx.reply(embed=embed)
    ...
    async def version(self, ctx):
        ...
        https://github.com/qoft/mediaforge-qoft

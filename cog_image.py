...
class Image(commands.Cog, name="Creation"):
    ...
    @commands.command(name="speechbubble")
    async def speechbubble(self, ctx):
        """
        Colors a trollface with an image.
        ...
        :mediaparam media: A video, gif, or image.
        """
        await improcess(ctx, captionfunctions.speechbubble, [["VIDEO", "GIF", "IMAGE"]], handleanimated=True)
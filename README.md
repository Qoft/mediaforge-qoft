# just my version of mediaforge, made working without a DB
...
[![stars](https://img.shields.io/github/stars/HexCodeFFF/mediaforge?style=social)](https://github.com/qoft/mediaforge-qoft/stargazers)
...
new, [please report any issues or unintended behavior.](https://github.com/qoft/mediaforge-qoft/issues)
...
```shell
docker build -t qoft/mediaforge-qoft https://github.com/qoft/mediaforge-qoft.git
docker run -it --cap-add SYS_NICE qoft/mediaforge-qoft
```
